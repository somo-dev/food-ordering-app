export const foodOptionsDetails = [
    {
        offerCategory: {
            ...
            offers: [
                {
                    info: {
                        ...
                        offerIds: [
                            "ce5f9f86-e9b3-4580-9a70-4ce54ffd449c"
                        ],
                ...
                },
                {
                    info: {
                        ...
                        offerIds: [
                            "56db52f1-36e0-43ba-ab1b-6859e655d8fd"
                        ],
                        expiryTime: "1970-01-01T00:00:00Z",
        ...
        info: {
            ...
            // uniqueId: "41eab84b-b00a-457d-80c8-5a62fadc4790",
            ...
            feeDetails: {
                ...
                message: "Far (7 kms) | Additional delivery fee will apply"
            },
            parentId: "19276",
            avgRatingString: "4.1",
            ...
            availability: {
                nextCloseTime: "2023-04-13 23:50:00",
                visibility: true,
                opened: true,
            ...
            badges: {},
            slugString: "cafe-bahar-cafe-restaurant-panjagutta-banjara-hills",
            isOpen: true,
            labels: [
                {
                    title: "Timings",
                ...
                {
                    title: "Address",
                    message: "6-3-694/1 &697, Panjagutta main road"
                },
                {
                    title: "Cuisines",
                    message: "Biryani,Chinese"
                }
            ],
            totalRatings: 10000,
            ...
            type: "F",
            headerBanner: {
                url: "swiggy://webview?is_external=false&webview_url=https://www.swiggy.com/restaurant-info/25251"
            },
            expectationNotifiers: [
                {
                    text: "Far (7 kms) | Additional delivery fee will apply",
                    icon: {
                    ...
                    enrichedText: "<b>Far (7 kms)</b> | Additional delivery fee will apply",
                    halfCardPopup: {
                        halfCardPopupHeader: {}
                    }
                }
        ...
        cards: [
            {
                card: {
                    card: {
                        types: "type.googleapis.com/swiggy.presentation.food.v2.MenuVegFilterAndBadge",
                        badges: {},
                        vegOnlyDetails: {
            ...
            },
            {
                card: {
                    card: {
                        types: "type.googleapis.com/swiggy.presentation.food.v2.ItemCategory",
                        title: "Recommended",
                        itemCards: [
                            {
                                card: {
                                    types: "type.googleapis.com/swiggy.presentation.food.v2.Dish",
                                    info: {
                                        id: "4685461",
                                        name: "Veg Biryani",
                                        category: "Biryani",
                                        description: "Serves 1 person",
                                        imageId: "apzrl8u4qbtckjecihmq",
                                        inStock: 1,
                                        isVeg: 1,
                                        price: 20000,
                                        variants: {},
            ...
            },
            {
                card: {
                    card: {
                        types: "type.googleapis.com/swiggy.presentation.food.v2.NestedItemCategory",
                        title: "Starters",
                        categories: [
                            {
